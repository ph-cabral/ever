...
//   const [desde, setDesde] = useState(daysAgo(10));
...
//       if (empleado && !(r.employee_name ?? "").toLowerCase().includes(empleado.toLowerCase())) return false;
...
//     const variant =
//       s === "NORMAL" ? "default" :
//       s === "REVISAR" ? "destructive" : "secondary";
...
//           Marcas de los relojes Hikvision agregadas por día.
//         </p>
//       </header>

//       <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-4">
//         <Input placeholder="Empleado…" value={empleado} onChange={(e) => setEmpleado(e.target.value)} />
...
//             )}
//             {filtered.map((r, i) => (
//               <TableRow key={`${r.employee_no}-${r.fecha}-${i}`}>
//                 <TableCell>
//                   <Link
...
//                 <TableCell>
//                   {(r.devices ?? "").split(",").map((o, idx, arr) => (
//                     <span key={o + idx}>
//                       <button
//                         onClick={() => setOrigen(o.trim())}
//                         className="text-primary hover:underline"
//                       >{o.trim()}</button>
//                       {idx < arr.length - 1 && ", "}
//                     </span>
